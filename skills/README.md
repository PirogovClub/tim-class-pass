...
- **`trading_visual_extraction/`**: Authoritative JSON schema and production prompt for analyzing trading education video frames (used in Step 2 of the pipeline). See also `docs/requirements/trading-visual-extraction-spec.md`.
