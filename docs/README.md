...
This folder describes **how the repo works today**: architecture, pipelines, API notes, examples, and handoffs.

| Area | Start here |
|------|----------------|
| Pipeline | [`pipeline.md`](pipeline.md), [`pipeline_structure_and_features.md`](pipeline_structure_and_features.md) |
...
| Operator UI & Frontends | [`../ui/README.md`](../ui/README.md) |
...
**Normative specs, phased plans, audits, and backlog** live under **[`requirements/`](requirements/README.md)** (not here).

**Submission-style audit artifacts** (Step 4.3 zips, screenshots, validation logs) stay under **[`../audit/`](../audit/README.md)** at the repo root.
