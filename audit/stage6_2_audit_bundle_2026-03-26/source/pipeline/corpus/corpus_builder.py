...
def build_corpus(
    ...
    skipped_registry_lessons: list[str] = []
    if lesson_registry_path is not None:
        lessons, skipped_registry_lessons = _lessons_from_registry(lesson_registry_path, input_root)
    else:
