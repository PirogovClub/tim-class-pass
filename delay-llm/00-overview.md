...
| Document | Governs |
|----------|---------|
| [docs/pipeline.md](../docs/pipeline.md) | End-to-end Step 0-3 flow, data-flow Mermaid, per-step artifact lifecycle |
| [docs/pipeline_structure_and_features.md](../docs/pipeline_structure_and_features.md) | Canonical output-path contract (`PipelinePaths`), feature flags, stage registry |
| [docs/FRAMEWORK_MODULES.md](../docs/FRAMEWORK_MODULES.md) | Module/function responsibility map, trigger tables |
| [docs/framework_file_function_reference.md](../docs/framework_file_function_reference.md) | Flat function/file lookup index |
| [docs/corpus_contract_v1.md](../docs/corpus_contract_v1.md) | Frozen v1 per-lesson input contract, global ID patterns, referential integrity |
| [docs/step2_corpus_build_notes.md](../docs/step2_corpus_build_notes.md) | Corpus merge CLI (`pipeline/corpus/`), enrichment, validation |
