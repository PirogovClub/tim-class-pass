import {
  ...
  MetricsCoverageConceptsSchema,
  MetricsCoverageLessonsSchema,
  MetricsFlagsResponseSchema,
  MetricsProposalUsefulnessSchema,
  MetricsQueueHealthResponseSchema,
  MetricsSummaryResponseSchema,
  MetricsThroughputResponseSchema,
...
export function getMetricsSummary() {
  return apiGet('/adjudication/metrics/summary', MetricsSummaryResponseSchema)
}

export function getMetricsQueues() {
  return apiGet('/adjudication/metrics/queues', MetricsQueueHealthResponseSchema)
}

export function getMetricsProposals() {
  return apiGet('/adjudication/metrics/proposals', MetricsProposalUsefulnessSchema)
}

export function getMetricsThroughput(window: '7d' | '30d' = '7d') {
  return apiGet(
    `/adjudication/metrics/throughput?window=${encodeURIComponent(window)}`,
    MetricsThroughputResponseSchema,
  )
}

export function getMetricsCoverageLessons() {
  return apiGet('/adjudication/metrics/coverage/lessons', MetricsCoverageLessonsSchema)
}

export function getMetricsCoverageConcepts() {
  return apiGet('/adjudication/metrics/coverage/concepts', MetricsCoverageConceptsSchema)
}

export function getMetricsFlags() {
  return apiGet('/adjudication/metrics/flags', MetricsFlagsResponseSchema)
}
