...
import { CompareUnitsPage } from '@/pages/CompareUnitsPage';
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'review/metrics', element: <ReviewMetricsPage /> },
