    ...
    <header className="border-b border-slate-200 bg-white/90 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
        <div>
          ...
          <p className="text-sm text-slate-500">Stage 6.4 read-only analyst browser (hybrid RAG + explorer).</p>
          <nav className="mt-2 flex flex-wrap gap-3 text-sm">
            <Link to="/search" className="text-blue-700 hover:underline">
              Search
            </Link>
            <Link to="/compare/units" className="text-blue-700 hover:underline">
              Compare units
            </Link>
            <Link to="/rag" className="text-blue-700 hover:underline">
              RAG alias → search
            </Link>
            <Link to="/review/queue" className="text-blue-700 hover:underline">
              Review queue
            </Link>
            <Link to="/review/metrics" className="text-blue-700 hover:underline">
              Review metrics
            </Link>
          </nav>
        </div>
